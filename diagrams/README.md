...
This folder exists for anything that doesn't fit that pattern — a genuinely complex diagram Mermaid can't reasonably express, or a visual design asset for [10-design/](../docs/10-design/) — not as the default home for architecture diagrams.
