...
> Status: Accepted. Full reasoning in [domain-model.md](../../02-domain/domain-model.md), [event-catalog.md](../../02-domain/event-catalog.md), and [audit-logging.md](../../08-security/audit-logging.md).
...
- `access_audit_events`' own retention clock must be at least as long as the longest clock among everything it audits — an audit record about a since-deleted SessionEvent still has to prove the deletion was lawful (see [clickhouse-schema.md](../../06-data/clickhouse-schema.md)).
