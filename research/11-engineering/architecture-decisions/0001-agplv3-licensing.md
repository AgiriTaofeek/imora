...
> Status: Accepted. Full reasoning in [Licensing](../../01-product/README.md#licensing).
...
- **Source-available (Sentry's FSL, HashiCorp's old BSL):** rejected — not OSI-approved, and procurement teams at regulated orgs actively screen license type as an evaluation criterion, per [Target Users](../../00-overview/README.md#target-users).
...
- Revenue has to come from Milestone 3 (managed hosting, support SLAs, SSO, multi-region tooling) per [Pricing](../../01-product/README.md#pricing) — never from gating core functionality.
